...
# Load the answers
with open("Completions/Ultrafeedback/random-completions.txt", "r", encoding="utf-8") as f:
    raw = f.read()
...
if using_ref_completions:
    ...
    with open("Completions/Ultrafeedback/base-completions.txt", "r", encoding="utf-8") as f:
        raw = f.read()
